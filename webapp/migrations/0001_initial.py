...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha', models.DateTimeField(default=datetime.datetime(2020, 3, 14, 23, 9, 0, 968749))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('textoOtros', models.TextField(default='', max_length=240, verbose_name='Otras tareas')),
                ('comentario', models.CharField(default='', max_length=240)),
                ('kilometros', models.IntegerField(default=0)),
                ('puntuacion', models.IntegerField(default=0)),
                ('costo', models.IntegerField(default=0)),
                ('estados', models.ManyToManyField(through='webapp.EstadoServicio', to='webapp.Estado', verbose_name='Estado')),
